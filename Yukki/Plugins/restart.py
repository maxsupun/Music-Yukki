...
from Yukki.YukkiUtilities.database.queue import (get_active_chats, is_active_chat,
                                                 add_active_chat, remove_active_chat,
                                                 music_on, is_music_playing, music_off)
...
async def bot_leave_group(_, message):
    ...
    try:
        ...
        return
    await message.reply_text("✅ Bot has left from the chat.")
