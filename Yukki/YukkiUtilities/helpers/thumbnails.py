...
async def gen_thumb(thumbnail, title, userid, theme, ctitle):
    ...
    font2 = ImageFont.truetype("cache/finalfont.ttf", 60)
    draw.text((35, 550), f"Playing on {ctitle[:15]}...", fill="black", font=font)
    draw.text((35, 630), f"{title[:20]}...", fill= "black", stroke_width = 1, stroke_fill="black", font=font2)
