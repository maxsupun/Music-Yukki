...
async def gen_thumb(thumbnail, title, userid, theme, ctitle):
    ...
    draw.text((40, 550), f"Playing on {ctitle[:20]}...", fill="black", stroke_width = 1, stroke_fill="black" ,font=font)
    draw.text((40, 630), f"{title[:25]}...", fill= "black", stroke_width = 1, stroke_fill="black", font=font2)
