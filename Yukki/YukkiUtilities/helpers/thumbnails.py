...
async def gen_thumb(thumbnail, title, userid, theme, ctitle):
    ...
    font = ImageFont.truetype("cache/Roboto-Medium.ttf", 60)
    font2 = ImageFont.truetype("cache/finalfont.ttf", 65)
    draw.text((30, 550), f"Playing on {ctitle[:10]}...", fill="black", font=font)
    draw.text((30, 630), f"{title[:20]}...", fill= "black", stroke_width = 1, stroke_fill="black", font=font2)
